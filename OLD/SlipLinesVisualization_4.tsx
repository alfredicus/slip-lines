    ...
    useEffect(() => {
        ...
        if (controls.showEquipotential) {
            ...
            if (controls.showSpecialEquipotential) {
                equipotentials = equipotentials.filter(curve => 
                    Math.abs(curve.iso_level - S2) > 1e-6
                );
            }
        ...
        if (controls.showSpecialEquipotential) {
            ...
            const specialMeridian = generateSpecialEquipotentialMeridian(controls.S1, controls.S3, S2, config);
            addLinesToScene([specialMeridian], controls.specialEquipotentialColor, sphereGroupRef.current, false, true);
        }
